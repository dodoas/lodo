...
//  ['strikethrough','subscript','superscript','separator'],
    ...
    ['forecolor','HorizontalRule','Createlink','InsertImage','InsertTable','htmlmode','separator'],
...
this.stylesheet = "/WO60/css/frontend.css"; // full URL to stylesheet

this.fontstyles = [     // make sure these exist in the header of page the content is being display as well in or they won't work!
    { name: "Heading (large)",     className: "heading1",  classStyle: "font-size: large; font-family: font-family: Arial, Helvetica, sans-serif; color: #000000;" },
    { name: "Heading (medium)",    className: "heading2",  classStyle: "font-size: medium; font-family: Arial, Helvetica, sans-serif; color: #000000;" },
    { name: "Heading (small)",    className: "heading3",  classStyle: "font-size: small; font-family: Arial, Helvetica, sans-serif; color: #000000;" },
    { name: "Normal",    className: "mainText",  classStyle: "font-size: x-small; font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; color: #000000;" },
];
...
function editor_generate(objname,userConfig) {
  ...
  if (win_ie_ver < 5.5) { return false; }
...
/* ---------------------------------------------------------------------- *\
  ...
  Usage       :
  Arguments   : action_id - button id string with editor and action name
\* ---------------------------------------------------------------------- */

function editor_action(action_id) {

  // split up button name into "editorID" and "cmdID"
  var BtnParts = Array();
  BtnParts = action_id.split("_");
  var objname    = action_id.replace(/^_(.*)_[^_]*$/, '$1');
  var cmdID      = BtnParts[ BtnParts.length-1 ];
  var action_obj = document.all[action_id];
  ...
  var idx = action_obj.selectedIndex;
  var val = (idx != null) ? action_obj[ idx ].value : null;
