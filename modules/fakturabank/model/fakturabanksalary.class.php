...
class lodo_fakturabank_fakturabanksalary {
    ...
    public function createSalaryXML($SalaryID, $SalaryConfID) {
        ...
        $xml_content .= "<origin_system_saved_by>" . $head->SavedByInLodo . "</origin_system_saved_by>\n";
