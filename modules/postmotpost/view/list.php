                ...
                foreach($account as $voucher)
                {
                    ...
                    <td class="number"><nobr><? if($voucher->ForeignAmountIn > 0) { print $_lib['format']->Amount($voucher->ForeignAmountIn); } ?></nobr></td>
                        ...
                        <td class="<? print $class ?>">
                          <? print $_lib['form3']->text(array('table'=>'voucher', 'field'=>'InvoiceID', 'pk' => $voucher->VoucherID, 'value' => $voucher->InvoiceID, 'width' => 25, 'id' => 'invoice')); ?>
                        ...
                        <td class="<? print $class ?>">
                          <? print $_lib['form3']->text(array('table'=>'voucher', 'field'=>'KID', 'pk' => $voucher->VoucherID, 'value' => $voucher->KID, 'width' => 25, 'id' => 'kid')); ?>
                        ...
                        <td class="<? print $class ?>">
                          <? print $_lib['form3']->text(array('table'=>'vouchermatch', 'field'=>'MatchNumber', 'pk' => $voucher->VoucherMatchID, 'value' =>  $voucher->MatchNumber == "0" ? "" : $voucher->MatchNumber, 'width' => 25, 'id' => 'match')); ?>
