...
<body>
  <table>
    <thead>
      <tr>
        <th>Firma: </th>
        <th><? print $_lib['sess']->get_companydef('CompanyName') ?></th>
      <tr>
        <th>Adresse: </th>
        <th><? print $_lib['sess']->get_companydef('VAddress') ?></th>
      </tr>
      <tr>
        <th>Post: </th>
        <th><? print $_lib['sess']->get_companydef('VZipCode') ?> <? print $_lib['sess']->get_companydef('VCity') ?></th>
      </tr>
      <tr>
        <th>Orgnummer: </th>
        <th><? print $_lib['sess']->get_companydef('OrgNumber') ?></th>
      </tr>
      <tr>
        <th>Periode: </th>
        <th><? print "$termin->FromPeriod - $termin->ToPeriod" ?></th>
        <th>Valgt p&aring grunnlag av</th>
        <th><? print isset($_REQUEST['altinn']) ? "Altinndato" : "Periode" ?></th>
      </tr>
    </thead>
  </table>
  <br><br>
