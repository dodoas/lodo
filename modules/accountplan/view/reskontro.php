...
<input type="hidden" name="JournalID" value="<? print $JournalID ?>">
  ...
  <tr>
    ...
    <td>Default: <? $_lib['form2']->car_menu2(array('table' => $db_table, 'field' => 'CarID', 'value' => $account->CarID, 'tabindex' => $tabindex++, 'all_cars' => true, 'unset' => true)) ?></td>
    <td colspan="2"></td>
    <td></td>
  </tr>
  <tr>
    ...
    <td>Default: <? $_lib['form2']->project_menu2(array('table' => $db_table,  'field' =>  'ProjectID',  'value' =>  $account->ProjectID, 'tabindex' => $tabindex++, 'accesskey' => 'P', 'unset' => true)) ?></td>
    <td colspan="2"></td>
    <td></td>
  </tr>
  <tr>
    ...
    <td>Default: <? $_lib['form2']->department_menu2(array('table' => $db_table, 'field' => 'DepartmentID', 'value' => $account->DepartmentID, 'tabindex' => $tabindex++, 'accesskey' => 'V', 'unset' => true)) ?></td>
    <td colspan="2"></td>
    <td></td>
  </tr>
  <tr>
