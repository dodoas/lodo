...
<input type="hidden" name="JournalID" value="<? print $JournalID ?>">
  ...
  <tr class="result">
    <th colspan="6">Ansatt <? print $AccountPlanID ?> (underkonto til hovedbok)</th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2">Etternavn (Kun for personer)</td>
  ...
  <tr>
    ...
    <td></td>
    <td><input class="lodoreqfelt" type="text" name="accountplan.ZipCode" value="<? print $account->ZipCode  ?>" size="4"></td>
    <td colspan="2">Poststed</td>
    <td><input class="lodoreqfelt" type="text" name="accountplan.City" value="<? print $account->City  ?>" size="20"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2">Postbokspostnummersted</td>
  ...
  <tr>
    ...
    <td><input type="hidden" name="accountplan.EnableCredit" value="1"/><? /* $_lib['form2']->checkbox2($db_table, "EnableCredit", $account->EnableCredit,''); */ ?></td>
    ...
    <td colspan="2">Siste l&oslash;nnsendrings dato:</td>
    <td><? print $_lib['form3']->date(array('table'=>$db_table, 'field'=>'CreditDaysUpdatedAt', 'form_name' => $form_name, 'value'=>$account->CreditDaysUpdatedAt, 'class'=>'lodoreqfelt')) ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td></td>
    <td colspan="4"><? print $_lib['form3']->date(array('table'=>$db_table, 'field'=>'BirthDate', 'form_name' => $form_name, 'value'=>$account->BirthDate, 'class'=>'lodoreqfelt')) ?> (Brukes for beregning av arbeidsgiveravgift over/under 62 &aring;r)</td>
  </tr>
  <tr>
  ...
  <tr class="result">
    <th colspan="6">Altinn felt</th>
  </tr>
  <tr>
    <td class="menu">Skifttype:</td>
    <td></td>
    <td><? print $_lib['form3']->Generic_menu3(array('data' => $_lib['form3']->_ALTINN['ShiftTypes'], 'width'=>100, 'table'=> 'accountplan', 'field'=>'ShiftType', 'value'=>$account->ShiftType, 'class'=> 'lodoreqfelt')); ?></td>
    <td colspan="2">Timer hver uke ved full stilling:</td>
    <td><input class="lodoreqfelt" type="text" name="accountplan.Workmeasurement" value="<?= $account->Workmeasurement ?>" /></td>
  </tr>
  <tr>
    <td class='menu'>Arbeidstid:</td>
    <td></td>
    <td><? print $_lib['form3']->Generic_menu3(array('data' => $_lib['form3']->_ALTINN['WorkTimeSchemeTypes'], 'table'=> 'accountplan', 'field'=>'WorkTimeScheme', 'value'=>$account->WorkTimeScheme, 'class'=> 'lodoreqfelt')); ?></td>
    <td colspan="2">Ansettelsestype:</td>
    <td><? print $_lib['form3']->Generic_menu3(array('data' => $_lib['form3']->_ALTINN['TypeOfEmploymentTypes'], 'table'=> 'accountplan', 'field'=>'TypeOfEmployment', 'value'=>$account->TypeOfEmployment, 'width' => 32, 'class'=> 'lodoreqfelt')); ?></td>
  </tr>
  <tr>
    <td class='menu'>Yrke</td>
    <td></td>
    <td><? print $_lib['form3']->Occupation_menu3(array('table'=>$db_table, 'field'=>'OccupationID', 'value'=>$account->OccupationID, 'class'=> 'lodoreqfelt')); ?></td>
    <td colspan="2">Samme posisjon siden:</td>
    <td><? print $_lib['form3']->date(array('table'=>'accountplan', 'field'=>'inCurrentPositionSince', 'form_name' => $form_name, 'value'=>$account->inCurrentPositionSince, 'class'=> 'lodoreqfelt')) ?></td>
  </tr>

  <tr class="result">
    <th colspan="6">Timeliste</th>
  </tr>
  <tr>
    <td class="menu">Passord</td> <td></td>
    <td><input type="text" name="timesheetpasswords.Password" value="<?= $password->Password ?>" /></td>
    <td colspan="3">Ansatt logger inn med:</td>
  </tr>
  <tr>
    ...
    <td colspan="3">
      Database: <b><?= $_SESSION['DB_NAME'] ?></b><br />
      Brukernavn: <b><?= $AccountPlanID ?></b> eller <b><?= $account->AccountName ?></b><br />
      Passord: <b><?= $password->Password ?></b>
    </td>
  </tr>
