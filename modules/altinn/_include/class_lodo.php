...
class Lodo
{
	...
	function Lodo()
	{
		...
		if ( is_object( $_lib['sess'] ) )
		{
			$this->inLodo = true;
			$this->lodoCurrentUserId = $_lib['sess']->login_id;
			$this->lodoCurrentClientName = $_lib['sess']->get_companydef('VName');
			...
			$this->lodoCompany = array(
				'name' => $_lib['sess']->get_companydef('VName'),
				'streetaddr' => $_lib['sess']->get_companydef('VAddress'),
				'zipcode' => $_lib['sess']->get_companydef('VZipCode'),
				'city' => $_lib['sess']->get_companydef('VCity')
				);
		}
