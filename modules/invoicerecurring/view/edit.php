...
<thead>
    ...
    <tr>
        ...
        <td><b>Mottaker</b></td>
        <td style="border:2px"><? print $_lib['form3']->accountplan_number_menu(array('table'=>$db_table, 'field'=>'CustomerAccountPlanID', 'pk'=>$RecurringID, 'value'=>$row->CustomerAccountPlanID,  'type' => array(0 => customer), 'class' => 'combobox', 'onlyonce'=> true)) ?></td>
    </tr>
    <tr>
        <td>Adresse</a></td>
