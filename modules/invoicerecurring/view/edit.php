...
<tbody>
    ...
    <tr>
      <td>Prosjekt</td>
      <td><? $_lib['form2']->project_menu2(array('table' => $db_table,  'field' =>  'ProjectID', 'pk'=>$RecurringID,  'value' =>  $row->ProjectID, 'unset' => true)) ?></td>
      <td>Prosjekt</td>
    ...
    <tr>
      <td>Avdeling</td>
      <td><? $_lib['form2']->department_menu2(array('table' => $db_table, 'field' => 'DepartmentID', 'pk'=>$RecurringID, 'value' => $row->DepartmentID, 'unset' => true)); ?></td>
      <td>Avdeling</td>
