...
if(!$include)
{
    ...
    #hvorfor var dette avsnittet kommentert bort? $_SESSION['DB_NAME'] ble ikke satt noe sted, den mÂ jo bli satt til valgt database?
    #---------- START -------------#
    ...
    require_once($_SETUP['HOME_DIR'] . "/code/lib/session/session.class.php"); #Må være etter auth
...
#Fang opp at fil ikke finnes, må støtte debug flagg.
