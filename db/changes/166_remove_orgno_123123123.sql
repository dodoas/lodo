...
DELETE FROM accountplanscheme WHERE SchemeValue = '123123123' AND FakturabankSchemeID IN ((SELECT FakturabankSchemeID FROM fakturabankscheme WHERE SchemeType IN ('NO:ORGNR', 'NO:VAT')), 0, NULL);
