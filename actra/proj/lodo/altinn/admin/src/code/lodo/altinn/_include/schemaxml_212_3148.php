<?php
	if ( $head == true )
	{
		$xml = '<GenerellInformasjon-grp-2581 gruppeid="2581">
					<Avgiftspliktig-grp-50 gruppeid="50">
						...
						<OppgaveType-datadef-5659 orid="5659"></OppgaveType-datadef-5659>
	...
	{
		$xml = '<Skjema xmlns:brreg="http://www.brreg.no/or" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" skjemanummer="212" spesifikasjonsnummer="3148" blankettnummer="RF-0002" tittel="Alminnelig omsetningsoppgave" gruppeid="20" etatid="974761076"><GenerellInformasjon-grp-2581 gruppeid="2581">
	<Avgiftspliktig-grp-50 gruppeid="50">
		<EnhetBedriftNavn-datadef-21771 orid="21771">' . $this->lodo->lodoCompany['name'] . '</EnhetBedriftNavn-datadef-21771>
		<EnhetBedriftAdresse-datadef-21773 orid="21773">' . $this->lodo->lodoCompany['streetaddr'] . '</EnhetBedriftAdresse-datadef-21773>
		<EnhetBedriftPostnummer-datadef-21774 orid="21774">' . $this->lodo->lodoCompany['zipcode'] . '</EnhetBedriftPostnummer-datadef-21774>
...
<Avgiftsposter-grp-2577 gruppeid="2577">
	...
	<BeregnetAvgift-grp-2579 gruppeid="2579">
		...
		<AvgiftTerminTilGode-datadef-8452 orid="8452">' . $this->data[ 'd8452' ] . '</AvgiftTerminTilGode-datadef-8452>
		<AvgiftTerminABetale-datadef-8453 orid="8453">' . $this->data[ 'd8453' ] . '</AvgiftTerminABetale-datadef-8453>
	</BeregnetAvgift-grp-2579>
...
</Tilleggsopplysninger-grp-197></Skjema>';
	}
?>
